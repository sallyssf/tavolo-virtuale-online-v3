...
function sheet(name,cls){return{name,class:cls,level:1,race:"",background:"",ac:10,speed:9,stats:{Forza:10,Destrezza:10,Costituzione:10,Intelligenza:10,Saggezza:10,Carisma:10},proficiencies:[],saves:[],inventory:[],conditions:[]}}
